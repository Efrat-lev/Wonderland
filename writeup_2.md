...
כדי להבין איך הקלט נבדק, פתחתי את הקובץ ב-IDA. התחלתי את החיפוש בחלון ה-Strings (Shift+F12) ואיתרתי את מחרוזת הפתיחה של השלב. לחיצה כפולה הובילה אותי ל-Data Segment, ומשם השתמשתי בהפניות (Xrefs) כדי לקפוץ אל הפונקציה שמשתמשת במחרוזת הזו - פונקציית האימות `sub_401330`.
